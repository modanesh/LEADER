...
public:
	...
	// code by Mohamad
	double IS_Sample(int& intention, int& mode, std::vector<double> learned_weights);
    ...
    std::vector<double> Extract() {
        std::vector<double> extracted_b;
        for (double intention_prob: probs_[AGENT_ATT]) {
            extracted_b.push_back(intention_prob);
        }
        return extracted_b;
    }
...
;
	...
	// code by Mohamad
	double IS_Sample(int& intention, int& mode, std::vector<double> learned_weights) const;
